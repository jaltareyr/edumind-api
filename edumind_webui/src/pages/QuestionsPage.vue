      ...
      <v-row class="questions-page__grid" align="stretch" justify="stretch">
        <v-col cols="12" md="4" lg="3" class="questions-page__filters">
          ...
          <v-btn
            ...
            @click="questionsStore.openExportDialog"
          >
            Export Questions
          </v-btn>
        </v-col>
            ...
            <v-card>
              ...
              <v-card-text>
                <v-radio-group
                  ...
                  class="mb-4"
                >
                  <v-radio label="CSV (.csv)" value="csv" />
                  <v-radio label="QTI (IMS ZIP)" value="qti" />
                </v-radio-group>
              ...
              <v-card-actions class="justify-end">
                <v-btn variant="text" @click="questionsStore.closeExportDialog">
                  Cancel
                </v-btn>
                <v-btn
                  color="primary"
                  ...
                  @click="questionsStore.exportQuestions"
                >
                  Export
                </v-btn>
              </v-card-actions>
...
const { loading, uniqueTags, filteredQuestions, resultsSummary, sessionsLoading, exportDialogOpen, exportFormat, exportFileName, exporting } = storeToRefs(questionsStore);
